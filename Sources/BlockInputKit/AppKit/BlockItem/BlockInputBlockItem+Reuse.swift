...
extension BlockInputBlockItem {
    ...
    func resetChromeForReuse() {
        ...
        scrollViewBottomConstraint?.constant = 0
        metadataRowHeightConstraint?.constant = 0
        metadataRowHeightConstraint?.isActive = false
        metadataRowLeadingConstraint?.isActive = false
        metadataRowTrailingConstraint?.isActive = false
        ...
        imageBlockLeadingConstraint?.isActive = false
        imageBlockTrailingConstraint?.isActive = false
        imageBlockWidthConstraint?.isActive = false
        imageBlockTopConstraint?.isActive = false
        imageBlockBottomConstraint?.isActive = false
        detailButton.isHidden = true
        detailButton.alphaValue = 0
        detailButtonLeadingConstraint?.isActive = false
        detailButtonTopConstraint?.isActive = false
        detailButtonWidthConstraint?.isActive = false
        detailButtonHeightConstraint?.isActive = false
        detailButtonTrailingConstraint?.isActive = false
